  ...
  return (
    <footer className='flex flex-col justify-center items-center bg-[#0c1933]'>
        <div className="flex flex-col justify-center items-center text-white p-4 xl:w-[900px]">
            ...
            Este proyecto se ha inspirado en algunos componentes del <a className='hover:text-green-600' href="https://vercel.com/templates/next.js/ai-code-translator" target="_blank" rel="noreferrer">Template Vercel</a>
            </p>
