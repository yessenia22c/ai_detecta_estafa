...
export const Resultados : React.FC<Props> = ({responseString}) => {
  return (
    <div className="xl:w-[900px] flex flex-col justify-center items-center m-4 w-full">
        ...
        <a href="#resultados" >
        <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#2a9d90"><path d="m480-340 180-180-57-56-123 123-123-123-57 56 180 180Zm0 260q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Z"/></svg>
        </a>
        <br />
        <div className="text-white text-[16px] py-4 flex text-center gap-2 max-[780px]:w-full">
          ...
          <h3 className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap">{responseString?.data?.url}</h3>
      </div>
        <p className="text-[16px] text-white text-wrap py-4">{responseString?.data?.descripcion}</p>
        <div id="resultados" className="md:flex flex-row py-16  gap-8 ">
          <div>
        ...
        <h2 className="font-medium text-[18px]"> Recomendación</h2>
        <p className="text-[16px] text-white text-wrap py-4">{responseString?.data?.recomendacion}</p>
    </div>
  )
}
