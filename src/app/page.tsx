    ...
    <>
      ...
      <div className="flex h-full min-h-screen flex-col items-center bg-[#091224] px-4 py-20 text-neutral-200 sm:px-10">
        ...
        <div
          className={` ${
            verificando ? "hidden" : ""
          } flex flex-col m-0 justify-center items-center`}
        >
          <img
            className="sm:w-[300px] xl:w-[430px] animate-upDown"
            src="/robot-analizando-1.webp"
            alt="un robot analizando un sitio web"
          />
          <img
            className="w-[480px] animate-upDownScala"
            src="/luz-robot.webp"
            alt="luz del robot"
          />
        </div>
